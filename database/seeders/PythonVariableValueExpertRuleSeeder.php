    ...
    public function run(): void
    {
        DB::transaction(function (): void {
            ...
            DB::table('question_bank')
                ->where('QuestionID', $questionId)
                ->update([
                    'QuestionText' => 'ما الفرق بين المتغير والقيمة في Python؟ أعط مثالًا بسيطًا.',
                    'Topic' => self::TOPIC,
            ...
            foreach ($this->contradictions() as $contradiction) {
                $contradictionRuleId = DB::table(
                    ...
                    'RuleSetID' => $ruleSetId,
                    'TriggerConceptID' => $conceptIds[$contradiction['trigger_concept']],
    ...
    private function concepts(): array
    {
        return [
            [
                ...
                'description_ar' => 'يوضح أن المتغير اسم أو معرّف مرتبط بقيمة أو كائن.',
                'claim_ar' => 'الطالب يذكر أن المتغير اسم أو معرّف يشير إلى قيمة أو كائن.',
                'claim_en' => 'The student states that a variable is a name or identifier that refers to a value or object.',
            ],
            [
                ...
                'description_ar' => 'صياغة مبسطة مقبولة جزئيًا لتعريف المتغير.',
                'claim_ar' => 'الطالب يذكر أن المتغير يحمل أو يخزن بيانات أو قيمة دون تعريف أدق.',
                'claim_en' => 'The student states, less precisely, that a variable holds or stores data or a value.',
            ],
            [
                'code' => 'value_is_data_or_literal',
                'name_ar' => 'القيمة تمثل البيانات أو literal',
                'name_en' => 'Value is data or a literal',
                'description_ar' => 'يوضح أن القيمة هي البيانات نفسها مثل رقم أو نص.',
                'claim_ar' => 'الطالب يذكر أن القيمة تمثل البيانات نفسها مثل رقم أو نص أو literal.',
                'claim_en' => 'The student states that a value is data itself, such as a number, string, or literal.',
            ],
            [
                ...
                'description_ar' => 'يوضح أن x = 5 تربط القيمة 5 بالاسم x.',
                'claim_ar' => 'الطالب يوضح أن عملية الإسناد تربط قيمة باسم متغير، مثل x = 5.',
                'claim_en' => 'The student explains that assignment binds a value to a variable name, such as x = 5.',
            ],
            [
                'code' => 'valid_python_assignment_example',
                'name_ar' => 'مثال إسناد Python صحيح',
                'name_en' => 'Valid Python assignment example',
                'description_ar' => 'يقدم مثال إسناد صحيحًا مثل x = 5.',
                'claim_ar' => 'الطالب يقدم مثال Python صحيحًا يربط قيمة بمتغير، مثل x = 5.',
                'claim_en' => 'The student provides a valid Python assignment example such as x = 5.',
            ],
            [
                ...
                'description_ar' => 'خلط صريح بين مفهوم المتغير والقيمة.',
                'claim_ar' => 'الطالب يدعي أن المتغير والقيمة شيء واحد أو لا فرق بينهما.',
                'claim_en' => 'The student claims that a variable and a value are the same thing.',
            ],
            [
                'code' => 'assignment_roles_reversed',
                'name_ar' => 'عكس أدوار المتغير والقيمة',
                'name_en' => 'Assignment roles are reversed',
                'description_ar' => 'مثل اعتبار 5 متغيرًا وx قيمة في x = 5.',
                'claim_ar' => 'الطالب يقول إن 5 هو المتغير وx هي القيمة في x = 5.',
                'claim_en' => 'The student says that 5 is the variable and x is the value in x = 5.',
            ],
            [
                ...
                'description_ar' => 'تناقض مع تعريف المتغير الصحيح.',
                'claim_ar' => 'الطالب يدعي أن المتغير لا يشير أو لا يرتبط بقيمة.',
                'claim_en' => 'The student claims that a variable does not refer to or relate to a value.',
            ],
            [
                'code' => 'value_is_variable_name_claim',
                'name_ar' => 'ادعاء أن القيمة هي اسم المتغير',
                'name_en' => 'Value is the variable name claim',
                'description_ar' => 'تناقض مع تعريف القيمة الصحيح.',
                'claim_ar' => 'الطالب يدعي أن القيمة هي اسم المتغير.',
                'claim_en' => 'The student claims that the value is the variable name.',
            ],
        ];
    }
    ...
    private function rubrics(): array
    {
        return [
            [
                ...
                'description_ar' => 'يوضح أن المتغير اسم أو معرّف يشير إلى قيمة أو كائن.',
                'max_score' => 2.00,
                'keywords' => [
                ...
                'feedback_fail' => 'وضح أن المتغير اسم أو معرّف يرتبط بقيمة أو كائن.',
                'order' => 1,
            ],
            [
                'code' => 'PY_VAR_DEFINE_VALUE',
                'name_ar' => 'تعريف القيمة',
                'description_ar' => 'يوضح أن القيمة تمثل البيانات مثل رقم أو نص أو كائن.',
                'max_score' => 1.00,
                'keywords' => ['value_is_data_or_literal'],
                'sample_good' => 'القيمة هي البيانات مثل 5 أو النص Ali.',
                'sample_bad' => 'القيمة هي اسم المتغير.',
                'feedback_pass' => 'وضحت أن القيمة تمثل البيانات بشكل صحيح.',
                'feedback_fail' => 'وضح أن القيمة تمثل البيانات مثل رقم أو نص.',
                'order' => 2,
            ],
            [
                'code' => 'PY_VAR_EXPLAIN_ASSIGNMENT',
                'name_ar' => 'توضيح العلاقة بين المتغير والقيمة',
                'description_ar' => 'يوضح أن الإسناد يربط قيمة باسم متغير، مثل x = 5.',
                'max_score' => 1.00,
                'keywords' => ['assignment_binds_value_to_variable'],
                'sample_good' => 'في x = 5، x متغير و5 قيمة.',
                'sample_bad' => 'في x = 5، الرقم 5 هو المتغير.',
                'feedback_pass' => 'وضحت العلاقة بين المتغير والقيمة بصورة صحيحة.',
                'feedback_fail' => 'وضح أن x متغير و5 قيمة في المثال x = 5.',
                'order' => 3,
            ],
            [
                ...
                'feedback_fail' => 'أضف مثال Python صحيحًا مثل: x = 5.',
                'order' => 4,
            ],
        ];
    }
    ...
    private function rules(): array
    {
        return [
            [
                ...
                'priority' => 10,
                'award_score' => 2.00,
                'feedback' => 'شرحت أن المتغير اسم أو معرّف يرتبط بقيمة.',
            ...
            [
                ...
                'priority' => 20,
                'award_score' => 1.00,
                'feedback' => 'ذكرت أن المتغير يحمل بيانات، لكن التعريف يحتاج دقة أكبر.',
            ...
            [
                ...
                'priority' => 10,
                'award_score' => 1.00,
                'feedback' => 'وضحت أن القيمة تمثل البيانات مثل رقم أو نص.',
            ...
            [
                ...
                'priority' => 10,
                'award_score' => 1.00,
                'feedback' => 'وضحت أن x هو المتغير و5 هي القيمة في عملية الإسناد.',
    ...
    private function contradictions(): array
    {
        return [
            [
                ...
                'feedback_ar' => 'يوجد خلط بين المتغير والقيمة؛ المتغير اسم أو معرّف، بينما القيمة هي البيانات المرتبطة به.',
                'blocked_rubrics' => [
            ...
            [
                ...
                'feedback_ar' => 'في x = 5، يكون x هو المتغير و5 هي القيمة.',
                'blocked_rubrics' => [
                    'PY_VAR_EXPLAIN_ASSIGNMENT',
            ...
            [
                ...
                'feedback_ar' => 'المتغير يمكن أن يشير إلى قيمة أو كائن؛ لا يصح القول إنه لا يرتبط بقيمة.',
                'blocked_rubrics' => ['PY_VAR_DEFINE_VARIABLE'],
            ],
            [
                'code' => 'PY_VAR_CONFLICT_VALUE_NAME',
                'trigger_concept' => 'value_is_variable_name_claim',
                'feedback_ar' => 'القيمة ليست اسم المتغير؛ القيمة هي البيانات، واسم المتغير هو المعرّف مثل x.',
                'blocked_rubrics' => [
                    'PY_VAR_DEFINE_VALUE',
                    'PY_VAR_EXPLAIN_ASSIGNMENT',
                ],
