...
class PythonFundamentalsExpertRulesSeeder extends Seeder
{
    ...
    private function definitions(): array
    {
        return [
            [
                ...
                'concepts' => [
                    [
                        ...
                        'description_ar' => 'يوضح أن جملة if تستخدم للتحقق من شرط.',
                        'claim_ar' => 'الطالب يذكر أن جملة if تتحقق من شرط أو تقارن '
                            .'نتيجة شرطية.',
                        'claim_en' => 'The student states that an if statement checks '
                    ...
                    [
                        ...
                        'description_ar' => 'يوضح أن الكود داخل if ينفذ عندما تكون نتيجة الشرط صحيحة.',
                        'claim_ar' => 'الطالب يذكر أن الكود داخل if ينفذ عندما يكون '
                            .'الشرط صحيحًا أو متحققًا.',
                        'claim_en' => 'The student states that code inside if executes '
                    ...
                    [
                        ...
                        'description_ar' => 'يقدم مثالًا صحيحًا يحتوي if وشرطًا واضحًا.',
                        'claim_ar' => 'الطالب يقدم مثالًا صحيحًا لجملة if في Python '
                            .'يتضمن if وشرطًا وكودًا ينفذ داخلها.',
                        'claim_en' => 'The student provides a valid Python if example '
                    ...
                    [
                        ...
                        'description_ar' => 'ادعاء خاطئ بأن if تنفذ الكود بغض النظر عن الشرط.',
                        'claim_ar' => 'الطالب يذكر أن if تنفذ الكود دائمًا أو بغض النظر '
                            .'عن نتيجة الشرط.',
                        'claim_en' => 'The student claims that an if statement executes '
                ...
                'rubrics' => [
                    [
                        ...
                        'description_ar' => 'يوضح أن if تتحقق من شرط قبل اتخاذ القرار.',
                        'max_score' => 2.00,
                        'requires' => ['py_if_checks_condition'],
                        'blocked_by' => ['py_if_always_executes_claim'],
                        'sample_good' => 'تتحقق if من شرط مثل العمر أكبر من 18.',
                        'sample_bad' => 'if تنفذ الأوامر دائمًا بلا شرط.',
                        'feedback_pass' => 'وضحت أن if تستخدم للتحقق من شرط.',
                        'feedback_fail' => 'لم توضّح أن وظيفة if الأساسية هي التحقق من شرط.',
                        'order' => 1,
                    ],
                    [
                        'code' => 'PY_IF_EXECUTES_WHEN_TRUE',
                        'name_ar' => 'تنفيذ الكود عند تحقق الشرط',
                        'description_ar' => 'يوضح أن الكود داخل if ينفذ عندما يكون الشرط صحيحًا.',
                        'max_score' => 2.00,
                        'requires' => ['py_if_executes_when_true'],
                        'blocked_by' => ['py_if_always_executes_claim'],
                        'sample_good' => 'ينفذ print عندما تكون قيمة الشرط True.',
                        'sample_bad' => 'ينفذ الكود حتى لو كان الشرط False.',
                        'feedback_pass' => 'وضحت أن الكود داخل if ينفذ عند تحقق الشرط.',
                        'feedback_fail' => 'لم توضّح متى ينفذ الكود الموجود داخل if.',
                        'order' => 2,
                    ],
                    [
                        'code' => 'PY_IF_VALID_EXAMPLE',
                        'name_ar' => 'مثال صحيح على if',
                        'description_ar' => 'يقدم مثالًا صحيحًا ومناسبًا لجملة if.',
                        'max_score' => 1.00,
                        'requires' => ['py_if_valid_example'],
                        'blocked_by' => [],
                        'sample_good' => 'if age >= 18: print("Adult")',
                        'sample_bad' => 'if = age 18',
                        'feedback_pass' => 'قدمت مثالًا صحيحًا على if.',
                        'feedback_fail' => 'أضف مثالًا صحيحًا يحتوي شرطًا وجملة if.',
                        'order' => 3,
                    ],
                ],
                'contradictions' => [
                    [
                        ...
                        'feedback_ar' => 'جملة if لا تنفذ الكود دائمًا؛ بل تنفذه عندما '
            ...
            [
                ...
                'concepts' => [
                    [
                        ...
                        'description_ar' => 'يوضح أن for تستخدم للتكرار على عناصر مجموعة أو range.',
                        'claim_ar' => 'الطالب يذكر أن for تستخدم للتكرار على عناصر '
                            .'قائمة أو مجموعة أو range.',
                        'claim_en' => 'The student states that a for loop iterates '
                    ...
                    [
                        ...
                        'description_ar' => 'يوضح أن while تستمر في التكرار ما دام الشرط صحيحًا.',
                        'claim_ar' => 'الطالب يذكر أن while تكرر تنفيذ الكود ما دام '
                            .'الشرط صحيحًا أو متحققًا.',
                        'claim_en' => 'The student states that a while loop repeats '
                    ...
                    [
                        ...
                        'description_ar' => 'يفرق بين for للتكرار على عناصر وwhile لشرط متغير.',
                        'claim_ar' => 'الطالب يوضح أن for مناسبة غالبًا عندما نكرر '
                            .'على عناصر معروفة أو range، بينما while مناسبة '
                            .'عندما يعتمد التكرار على استمرار شرط.',
                        'claim_en' => 'The student explains that for is commonly used '
                    ...
                    [
                        ...
                        'description_ar' => 'ادعاء خاطئ بأن for وwhile لهما نفس الاستخدام دائمًا.',
                        'claim_ar' => 'الطالب يذكر أن for وwhile متطابقتان تمامًا ولا '
                            .'يوجد فرق في طريقة استخدامهما.',
                        'claim_en' => 'The student claims that for and while are '
                ...
                'rubrics' => [
                    [
                        ...
                        'name_ar' => 'استخدام for',
                        'description_ar' => 'يوضح أن for تكرر على عناصر أو نطاق.',
                        'max_score' => 2.00,
                    ...
                    [
                        ...
                        'description_ar' => 'يوضح أن while تستمر ما دام الشرط صحيحًا.',
                        'max_score' => 2.00,
                    ...
                    [
                        ...
                        'description_ar' => 'يوضح متى نستخدم كل نوع من الحلقات.',
                        'max_score' => 1.00,
                        'requires' => ['py_for_while_usage_difference'],
                        'blocked_by' => ['py_for_while_identical_claim'],
                        'sample_good' => 'for لعناصر قائمة وwhile عند استمرار شرط مثل إدخال صحيح.',
                ...
                'contradictions' => [
                    [
                        ...
                        'feedback_ar' => 'for وwhile كلتاهما للحلقات، لكن for تستخدم غالبًا '
            ...
            [
                ...
                'concepts' => [
                    [
                        ...
                        'description_ar' => 'يوضح أن عناصر list يمكن تعديلها أو إضافتها أو حذفها.',
                        'claim_ar' => 'الطالب يذكر أن list قابلة للتعديل أو يمكن تغيير '
                            .'عناصرها أو إضافة وحذف عناصر منها.',
                        'claim_en' => 'The student states that a list is mutable and '
                    ...
                    [
                        ...
                        'description_ar' => 'يوضح أن عناصر tuple لا تعدل بعد إنشائها.',
                        'claim_ar' => 'الطالب يذكر أن tuple غير قابلة للتعديل أو لا '
                            .'يمكن تغيير عناصرها بعد إنشائها.',
                        'claim_en' => 'The student states that a tuple is immutable '
                    ...
                    [
                        ...
                        'description_ar' => 'يربط list بالبيانات المتغيرة وtuple بالبيانات الثابتة.',
                        'claim_ar' => 'الطالب يوضح أن list تفضل عندما نحتاج تعديل البيانات، '
                            .'وtuple تفضل عندما نريد قيماً ثابتة لا تتغير.',
                        'claim_en' => 'The student explains that lists are preferred '
                    ...
                    [
                        ...
                        'description_ar' => 'ادعاء خاطئ بأن عناصر list لا يمكن تعديلها.',
                        'claim_ar' => 'الطالب يذكر أن list غير قابلة للتعديل أو لا '
                            .'يمكن تغيير عناصرها.',
                        'claim_en' => 'The student claims that a list is immutable '
                    ...
                    [
                        ...
                        'description_ar' => 'ادعاء خاطئ بأن عناصر tuple يمكن تعديلها.',
                        'claim_ar' => 'الطالب يذكر أن tuple قابلة للتعديل أو يمكن '
                            .'تغيير عناصرها بعد إنشائها.',
                        'claim_en' => 'The student claims that a tuple is mutable '
                ...
                'rubrics' => [
                    ...
                    [
                        ...
                        'description_ar' => 'يوضح متى تكون list أو tuple مناسبة.',
                        'max_score' => 1.00,
                        ...
                        'sample_good' => 'أستخدم list للمهام التي تتغير وtuple للإحداثيات الثابتة.',
                ...
                'contradictions' => [
                    [
                        ...
                        'feedback_ar' => 'list قابلة للتعديل؛ يمكن تغيير عناصرها أو إضافة وحذف عناصر.',
                        'blocked_rubrics' => [
                            'PY_LIST_MUTABLE',
                    ...
                    [
                        ...
                        'feedback_ar' => 'tuple غير قابلة للتعديل بعد إنشائها.',
                        'blocked_rubrics' => [
                            'PY_TUPLE_IMMUTABLE',
                            'PY_LIST_TUPLE_USE_CASE',
                        ],
            ...
            [
                ...
                'concepts' => [
                    [
                        ...
                        'description_ar' => 'يوضح استخدام open للقراءة بوضع r أو وضع القراءة الافتراضي.',
                        'claim_ar' => 'الطالب يذكر فتح الملف للقراءة باستخدام open مع '
                            .'الوضع r أو وضع القراءة الافتراضي.',
                        'claim_en' => 'The student states that a file is opened for '
                    ...
                    [
                        ...
                        'description_ar' => 'يوضح استخدام with open لإدارة الملف بأمان.',
                        'claim_ar' => 'الطالب يذكر استخدام with open عند فتح الملف '
                            .'للقراءة.',
                        'claim_en' => 'The student states that with open is used when '
                    ...
                    [
                        ...
                        'description_ar' => 'يوضح استخدام read أو طريقة قراءة مناسبة للمحتوى.',
                        'claim_ar' => 'الطالب يذكر استخدام read() أو readline() أو '
                            .'readlines() لقراءة محتوى الملف.',
                        'claim_en' => 'The student states that read(), readline(), or '
                    ...
                    [
                        ...
                        'description_ar' => 'يقدم مثالًا صحيحًا يجمع with open وقراءة المحتوى.',
                        'claim_ar' => 'الطالب يقدم مثال Python صحيحًا يستخدم with open '
                            .'لفتح ملف وread أو طريقة قراءة للمحتوى.',
                        'claim_en' => 'The student provides a valid Python example using '
                    ...
                    [
                        ...
                        'description_ar' => 'ادعاء خاطئ بأن وضع w هو الوضع المناسب لقراءة النص.',
                        'claim_ar' => 'الطالب يذكر أن الملف يجب فتحه بوضع w أو الكتابة '
                            .'من أجل قراءة محتواه.',
                        'claim_en' => 'The student claims that a file should be opened '
                ...
                'rubrics' => [
                    ...
                    [
                        ...
                        'description_ar' => 'يوضح استخدام with open لإغلاق الملف بأمان.',
                        'max_score' => 2.00,
                    ...
                    [
                        ...
                        'description_ar' => 'يقدم مثالًا صحيحًا يجمع فتح الملف وقراءة النص.',
                        'max_score' => 1.00,
                        'requires' => ['py_file_valid_read_example'],
                        'blocked_by' => [],
                        'sample_good' => 'with open("notes.txt", "r") as file: text = file.read()',
                ...
                'contradictions' => [
                    [
                        ...
                        'feedback_ar' => 'وضع w مخصص للكتابة وقد يفرغ الملف، أما القراءة فتستخدم '
            ...
            [
                'question_text' => 'اكتب دالة تأخذ قائمة أرقام وتُرجع قائمة جديدة تحتوي فقط على الأرقام الزوجية باستخدام Python.',
                ...
                'concepts' => [
                    [
                        ...
                        'description_ar' => 'يوضح أن الدالة لها معامل يمثل قائمة أرقام.',
                        'claim_ar' => 'الطالب يقدم دالة أو يذكر أن الدالة تستقبل قائمة '
                            .'أرقام كمعامل.',
                        'claim_en' => 'The student provides a function or states that '
                    ...
                    [
                        ...
                        'description_ar' => 'يوضح المرور على عناصر القائمة باستخدام for أو list comprehension.',
                        'claim_ar' => 'الطالب يذكر أو يقدم تكرارًا على عناصر قائمة الأرقام '
                            .'باستخدام for أو list comprehension.',
                        'claim_en' => 'The student states or provides iteration over '
                    ...
                    [
                        ...
                        'description_ar' => 'يوضح استخدام n % 2 == 0 لاختيار الأعداد الزوجية.',
                        'claim_ar' => 'الطالب يذكر أو يقدم شرطًا صحيحًا لفحص العدد الزوجي '
                            .'مثل n % 2 == 0.',
                        'claim_en' => 'The student states or provides a correct even '
                    ...
                    [
                        ...
                        'description_ar' => 'يوضح أن الناتج قائمة جديدة تحتوي الأعداد الزوجية.',
                        'claim_ar' => 'الطالب يذكر أو يقدم return لقائمة جديدة تحتوي '
                            .'الأرقام الزوجية فقط.',
                        'claim_en' => 'The student states or provides a return of a '
                    ...
                    [
                        ...
                        'description_ar' => 'ادعاء خاطئ بأن n % 2 == 1 هو شرط اختيار الأعداد الزوجية.',
                        'claim_ar' => 'الطالب يذكر أن n % 2 == 1 أو n % 2 != 0 هو '
                            .'الشرط الذي يختار الأعداد الزوجية.',
                        'claim_en' => 'The student claims that n % 2 == 1 or n % 2 != 0 '
                ...
                'rubrics' => [
                    [
                        ...
                        'description_ar' => 'يوضح أن الدالة تستقبل قائمة أرقام.',
                        'max_score' => 1.00,
                    ...
                    [
                        ...
                        'description_ar' => 'يوضح المرور على عناصر القائمة.',
                        'max_score' => 1.00,
                    ...
                    [
                        ...
                        'description_ar' => 'يستخدم شرط modulo الصحيح لاختيار الأعداد الزوجية.',
                        'max_score' => 2.00,
                    ...
                    [
                        ...
                        'name_ar' => 'إرجاع قائمة جديدة',
                        'description_ar' => 'يرجع قائمة جديدة تحتوي فقط الأعداد الزوجية.',
                        'max_score' => 1.00,
                ...
                'contradictions' => [
                    [
                        ...
                        'feedback_ar' => 'شرط العدد الزوجي هو n % 2 == 0، أما باقي القسمة 1 '
                            .'فيدل على عدد فردي.',
                        'blocked_rubrics' => [
                            'PY_EVEN_CONDITION',
            ...
            [
                ...
                'concepts' => [
                    [
                        ...
                        'description_ar' => 'يوضح أن exception مشكلة أو خطأ يحدث أثناء تشغيل البرنامج.',
                        'claim_ar' => 'الطالب يذكر أن exception هو خطأ أو مشكلة قد تحدث '
                            .'أثناء تنفيذ البرنامج.',
                        'claim_en' => 'The student states that an exception is an error '
                    ...
                    [
                        ...
                        'description_ar' => 'يوضح أن try توضع حول الكود الذي قد يرفع exception.',
                        'claim_ar' => 'الطالب يذكر أن try تحتوي الكود الذي قد يسبب خطأ '
                            .'أو exception.',
                        'claim_en' => 'The student states that try contains code that '
                    ...
                    [
                        ...
                        'description_ar' => 'يوضح أن except تلتقط الخطأ وتنفذ معالجة مناسبة.',
                        'claim_ar' => 'الطالب يذكر أن except تلتقط exception أو تتعامل '
                            .'مع الخطأ عند حدوثه.',
                        'claim_en' => 'The student states that except catches or handles '
                    ...
                    [
                        ...
                        'description_ar' => 'يقدم مثالًا صحيحًا يتضمن try وexcept.',
                        'claim_ar' => 'الطالب يقدم مثال Python صحيحًا يحتوي try وexcept '
                            .'لمعالجة خطأ.',
                        'claim_en' => 'The student provides a valid Python example using '
                    ...
                    [
                        ...
                        'description_ar' => 'ادعاء خاطئ بأن except تمنع أو تلغي تنفيذ كود try دائمًا.',
                        'claim_ar' => 'الطالب يذكر أن except تمنع تنفيذ كود try أو أن '
                            .'try لا تنفذ عند وجود except.',
                        'claim_en' => 'The student claims that except prevents try code '
                ...
                'rubrics' => [
                    [
                        ...
                        'description_ar' => 'يوضح أن exception مشكلة تحدث أثناء التنفيذ.',
                        'max_score' => 1.00,
                    ...
                    [
                        ...
                        'name_ar' => 'دور try',
                        'description_ar' => 'يوضح أن try تحتوي الكود المعرض للخطأ.',
                        'max_score' => 2.00,
                    ...
                    [
                        ...
                        'name_ar' => 'دور except',
                        'description_ar' => 'يوضح أن except تعالج الخطأ عند وقوعه.',
                        'max_score' => 1.00,
                    ...
                    [
                        ...
                        'description_ar' => 'يقدم مثالًا صحيحًا يجمع try وexcept.',
                        'max_score' => 1.00,
                        'requires' => ['py_try_except_valid_example'],
                        'blocked_by' => [],
                        'sample_good' => 'try: value = int(text) except ValueError: print("Invalid")',
                ...
                'contradictions' => [
                    [
                        ...
                        'feedback_ar' => 'كود try ينفذ أولًا، وعند حدوث exception تنتقل المعالجة '
                            .'إلى except المناسبة.',
                        'blocked_rubrics' => [
                            'PY_EXC_TRY_USAGE',
                            'PY_EXC_EXCEPT_USAGE',
            ...
            [
                ...
                'concepts' => [
                    [
                        ...
                        'description_ar' => 'يوضح أن class تمثل قالبًا أو تعريفًا لإنشاء objects.',
                        'claim_ar' => 'الطالب يذكر أن class هي قالب أو مخطط أو تعريف '
                            .'ننشئ منه objects.',
                        'claim_en' => 'The student states that a class is a blueprint '
                    ...
                    [
                        ...
                        'description_ar' => 'يوضح أن object هو instance منشأ من class.',
                        'claim_ar' => 'الطالب يذكر أن object هو instance أو كائن منشأ '
                            .'من class.',
                        'claim_en' => 'The student states that an object is an instance '
                    ...
                    [
                        ...
                        'description_ar' => 'يقدم مثالًا صحيحًا لتعريف class وإنشاء object منها.',
                        'claim_ar' => 'الطالب يقدم مثال Python صحيحًا يعرّف class ثم '
                            .'ينشئ object أو instance منها.',
                        'claim_en' => 'The student provides a valid Python example that '
                    ...
                    [
                        ...
                        'description_ar' => 'ادعاء خاطئ بأن class وobject لا فرق بينهما.',
                        'claim_ar' => 'الطالب يذكر أن class وobject الشيء نفسه تمامًا '
                            .'ولا يوجد فرق بينهما.',
                        'claim_en' => 'The student claims that a class and an object '
                ...
                'rubrics' => [
                    ...
                    [
                        ...
                        'name_ar' => 'مثال صحيح على class وobject',
                        'description_ar' => 'يقدم مثالًا يعرّف class وينشئ object منها.',
                        'max_score' => 1.00,
                        'requires' => ['py_class_object_valid_example'],
                        'blocked_by' => [],
                        'sample_good' => 'class Car: pass ثم car1 = Car()',
                ...
                'contradictions' => [
                    [
                        ...
                        'feedback_ar' => 'class هي قالب أو تعريف، بينما object هو instance '
                            .'منشأ من هذا القالب.',
                        'blocked_rubrics' => [
            ...
            [
                ...
                'concepts' => [
                    [
                        ...
                        'description_ar' => 'يوضح أن الاختبارات تتحقق من أن الدالة تعطي النتيجة المتوقعة.',
                        'claim_ar' => 'الطالب يذكر أن الاختبار يتحقق من السلوك أو '
                            .'الناتج المتوقع لدالة أو جزء من البرنامج.',
                        'claim_en' => 'The student states that a test verifies expected '
                    ...
                    [
                        ...
                        'description_ar' => 'يوضح أن الاختبارات تساعد على اكتشاف أخطاء أو regression بعد التغيير.',
                        'claim_ar' => 'الطالب يذكر أن الاختبارات تساعد على كشف الأخطاء '
                            .'أو منع regressions عند تعديل الكود.',
                        'claim_en' => 'The student states that tests help catch bugs or '
                    ...
                    [
                        ...
                        'description_ar' => 'يقدم مثالًا صحيحًا يستخدم assert أو اختبار unit test.',
                        'claim_ar' => 'الطالب يقدم مثالًا صحيحًا لاختبار unit test أو '
                            .'assert يقارن نتيجة فعلية بنتيجة متوقعة.',
                        'claim_en' => 'The student provides a valid unit-test or assert '
                    ...
                    [
                        ...
                        'description_ar' => 'ادعاء خاطئ بأن الاختبار وظيفته تغيير منطق الكود الإنتاجي.',
                        'claim_ar' => 'الطالب يذكر أن الاختبار وظيفته تغيير منطق الكود '
                            .'الإنتاجي أو تعديل النتيجة بدل التحقق منها.',
                        'claim_en' => 'The student claims that a test is meant to change '
                ...
                'rubrics' => [
                    [
                        ...
                        'description_ar' => 'يوضح أن الاختبار يقارن السلوك الفعلي بالمطلوب.',
                        'max_score' => 2.00,
                    ...
                    [
                        ...
                        'description_ar' => 'يوضح أن الاختبارات تكشف bugs أو regressions.',
                        'max_score' => 2.00,
                    ...
                    [
                        ...
                        'description_ar' => 'يقدم مثالًا صحيحًا يستخدم assert أو unit test.',
                        'max_score' => 1.00,
                ...
                'contradictions' => [
                    [
                        ...
                        'feedback_ar' => 'الاختبار يتحقق من سلوك الكود ولا يغير منطق الكود '
